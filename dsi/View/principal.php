...
<body class="w3-light-grey">
    ...
    <div class="w3-padding-large" id="main">
        <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais" style="">
            ...
            <form action="" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%; ">
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border w3-round-large" name="txtNome" type="date" placeholder="dd/mm/yyyy" value="">
                    </div>
                </div>
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border w3-round-large" name="txtNome" type="text" placeholder="000.000.000-00" value="">
                    </div>
                </div>
